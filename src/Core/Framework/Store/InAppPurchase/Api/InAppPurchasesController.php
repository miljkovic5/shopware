...
class InAppPurchasesController extends AbstractController
{
    ...
    public function activeInAppPurchases(Request $request, Context $context): JsonResponse
    {
    ...
    public function checkInAppPurchaseActive(Request $request, Context $context): JsonResponse
    {
        if (!$request->request->has('identifier')) {
            throw StoreException::missingIdentifier();
        }
