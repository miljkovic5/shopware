describe('src/app/main.ts', () => {
    ...
    it('should add all initializer to Application', () => {
        const expectedInitializers = [
            'apiServices', 'state', 'coreMixin', 'coreDirectives', 'coreFilter',
            'baseComponents', 'coreModuleRoutes', 'login', 'router', 'locale',
            'repositoryFactory', 'shortcut', 'httpClient', 'componentHelper',
